...
(function (root) {
  ...
  var CALIBRATION =
  {
    "provenance": "data_all/time_entries.csv (3,326 entries, 2831.3h, 2024-07-10..2026-07-09, ODL staff time) | 25 full-coverage course-dev projects >=10h (derived/ground_truth.csv); production rates from the 21 of them with >=10h non-PM logging",
    ...
    "coursePhaseMixPct": {
      "Production": 33.7,
      "Post-Production": 23.8,
      "Development/Build": 16.5,
      "Pre-Production": 16.3,
      "Design": 8.0,
      "Other / unsorted": 1.3,
      "Discovery": 0.4
    },
    "coursePhaseMixBasis": "pooled non-PM hours of 14 full-coverage full_course projects (945.8h)",
    "calendarWeeks": {
      "consult_or_studio": {
        "n": 1,
        "values": [
